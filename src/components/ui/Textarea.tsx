...
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(function Textarea(
  ...
  return (
    <textarea
      ...
      value={value}
      className={cn(
        "w-full break-words rounded-[var(--radius-field)] border bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-content)] placeholder:text-[var(--color-muted)] transition-colors resize-y",
